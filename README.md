...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-egibdtm.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-egibdtm.containers.anotherwebservice.com/
...
```
git clone git@github.com:Rishabh-77/container-egibdtm.git
cd container-egibdtm
```
...
```
docker attach container-egibdtm
```
